...
<template>
    <footer id="footer-section" style="min-height: 390px"     class="flex-1 bg-gradient-to-r from-purple-900 to-pink-600 bg-opacity-50 backdrop-filter backdrop-blur-lg">
