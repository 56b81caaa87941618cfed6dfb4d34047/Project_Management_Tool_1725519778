...
<template>
  <footer id="footer-section-container" style="min-height: 310px"     class="bg-gradient-to-r from-purple-900 to-pink-800 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg" >
          ...
          <div class="h-full flex flex-col sm:flex-row lg:flex-col justify-between">
            <div id="footer-logo-copyright" class="mb-4 sm:mb-0">
              ...
              <div id="footer-copyright" class="text-sm text-pink-200">
                © 2023 ProjectMaker. All rights reserved.
          ...
          <ul id="footer-block-2-list" class="text-sm space-y-2">
            <li>
              <a
                ...
                class="transition duration-150 ease-in-out text-pink-200 hover:text-white"
                href="#0"
              >
                Our Story
              </a>
...
<script>
export default {
  name: "dark_footer_component_1725519811",
  data() {
    return {
      expanded: false,
      tab: null,
