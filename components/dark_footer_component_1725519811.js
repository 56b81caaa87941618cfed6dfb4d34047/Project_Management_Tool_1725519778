...
<template>
  <footer id="footer-section-container" style="min-height: 190px"    class="bg-gradient-to-r from-purple-900 to-pink-800 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg" >
