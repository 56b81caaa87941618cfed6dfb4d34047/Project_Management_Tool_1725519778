...
<template>
    <footer id="footer-section" style="min-height: 70px" class="flex-1 bg-gradient-to-r from-purple-900 to-pink-600 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8">
