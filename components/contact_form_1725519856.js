<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Let's Bring Your Project to Life</h3>
        <p class="mt-3 text-black w-fit">Tell us about your vision, and we'll help you make it a reality</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Describe Your Project Idea</label>
          <textarea
            required
